...
public class HttpProcessor {
    ...
    /**
     * 接收来自传入的Http请求的套接字，对每个传入的Http请求，完成4个操作
     * 1、创建一个HttpRequest对象
     * 2、创建一个HttpRespones对象
     * 3、解析Http请求的第一行内容和请求头信息，填充HttpRequest对象
     * 4、讲HttpRequest对象和HttpResponse对象传递给servletProcessor或者StaticResourceProcessor的process()方法
     *
     * @param socket
     */
